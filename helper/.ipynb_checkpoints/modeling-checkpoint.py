...
class Ensemble(BaseModel):
    ...
    def __init__(self, model_name = 'ensemble', version = '1.0', stopword_path = "configs/vietnamese-stopwords-dash.txt"):
        self.version = version
        self.model_name = model_name
        self.models_dir = 'models/models_v'+version
        ...
        self.prepprocessor = TextPreprocessing(stopword_path)
        self.label_encoder, self.classnames = self.get_labelencoder()
    ...
    def ensemble_predict_proba(self, x):
        ...
        x_pre = [self.prepprocessor.transform(i) for i in x]
        predictions = []
    ...
    def ensemble_predict(self, x):
        ...
        res = map(lambda x: x.replace("_"," ").title(), pred_class)
